...
/**
 * Brand icons (Facebook, Instagram) were removed from lucide-react v1
 * for trademark reasons. These inline SVGs preserve the previous API
 * (className, width/height, currentColor) used across the app.
 */
...
export function Instagram({ className, ...props }: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
